...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "DeyGo" },
      { title: "DeyGo" },
      { name: "description", content: "DeyGo paratransit field app" },
      { name: "author", content: "DeyGo" },
      { property: "og:title", content: "DeyGo" },
      { property: "og:description", content: "DeyGo paratransit field app" },
